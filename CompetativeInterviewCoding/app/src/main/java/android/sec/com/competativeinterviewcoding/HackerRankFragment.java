...
public class HackerRankFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hacker_rank, container, false);
        WebView mWebView = (WebView) view.findViewById(R.id.hacker_rank);
        mWebView.setWebChromeClient(new WebChromeClient());
        mWebView.setWebViewClient(new WebViewClient());
        mWebView.getSettings().setJavaScriptEnabled(true);
        mWebView.loadUrl("https://www.hackerrank.com/");
        return view;
    }
