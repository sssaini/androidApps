...
public class HackerEarthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hacker_earth, container, false);
        WebView mWebView = (WebView) view.findViewById(R.id.hacker_earth);
        mWebView.setWebChromeClient(new WebChromeClient());
        mWebView.setWebViewClient(new WebViewClient());
        mWebView.getSettings().setJavaScriptEnabled(true);
        mWebView.loadUrl("https://www.hackerearth.com/");
        return view;
    }
